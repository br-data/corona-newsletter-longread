...
export function init(config) {
  ...
  const text = `Seit Beginn der Impfkampagne haben ${pretty(firstShotCount)} Menschen (insgesamt ${pretty(firstShotPerc)} %) in Bayern mindestens eine erste <a href="#impfungen">Impfdosis</a> erhalten. Davon sind ${pretty(secondShotCount)} Personen (insgesamt ${pretty(secondShotPerc)} %) inzwischen vollständig geimpft.
