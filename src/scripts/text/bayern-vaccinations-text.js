...
export function init(config) {
  ...
  const text = `Seit Beginn der Impfkampagne haben ${pretty(firstShotCount)} Menschen (insgesamt ${pretty(firstShotPerc)} %) in Bayern eine erste Impfdosis erhalten. Davon wiederum haben ${pretty(secondShotCount)} Personen (insgesamt ${pretty(secondShotPerc)} %) eine zweite Impfdosis erhalten und gelten als vollständig geimpft.
