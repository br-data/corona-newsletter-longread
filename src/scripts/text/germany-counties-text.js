...
export function init(config) {
  const { summaryTarget, detailTarget, cases } = config;
  ...
  const worstCounties = uniqueCounties.map(countyId => {
    ...
    return currentCountyCases[currentCountyCases.length - 1];
  ...
  ${preposition2(worstCounties[0].landkreisTyp)} ${worstCounties[0].landkreisTyp} ${worstCounties[0].landkreis} (${worstCounties[0].bundesland}) wurden bislang ${pretty(worstCounties[0].inzidenz)} Fälle pro 100.000 Einwohner in den letzten sieben Tagen gemeldet.

  ${preposition2(worstCounties[1].landkreisTyp)} ${worstCounties[1].landkreisTyp} ${worstCounties[1].landkreis} (${worstCounties[1].bundesland}) waren es ${pretty(worstCounties[1].inzidenz)} Fälle.

  Aus ${preposition3(worstCounties[2].landkreisTyp)} ${worstCounties[2].landkreisTyp} ${worstCounties[2].landkreis} (${worstCounties[2].bundesland}) wurden ${pretty(worstCounties[2].inzidenz)} Fälle gemeldet.`;
