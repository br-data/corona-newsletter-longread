...
export default class BayernMap {
  ...
  draw() {
    ...
    key.append('circle')
      .attr('transform', 'translate(275, 90)')
      .attr('r', radius(200))
      .attr('cx', radius(200))
      .attr('cy', 10)
    ...
    key.append('circle')
      .attr('transform', 'translate(375, 90)')
      .attr('r', radius(100))
      .attr('cx', radius(100))
      .attr('cy', 10)
    ...
    key.append('text')
      .attr('transform', 'translate(495, 90)')
      .attr('font-family', '"Open Sans", OpenSans, Arial')
      .attr('font-size', 15)
      .attr('font-weight', 300)
      .attr('fill', '#ffffff')
    ...
    key.append('text')
      .attr('transform', 'translate(573, 90)')
      .attr('font-family', '"Open Sans", OpenSans, Arial')
      .attr('font-size', 15)
      .attr('font-weight', 300)
      .attr('fill', '#ffffff')
    ...
    key.append('circle')
      .attr('transform', 'translate(625, 90)')
      .attr('r', radius(1))
      .attr('cx', radius(1))
      .attr('cy', 10)
    ...
    key.append('text')
      .attr('transform', 'translate(642, 90)')
      .attr('font-family', '"Open Sans", OpenSans, Arial')
      .attr('font-size', 15)
      .attr('font-weight', 300)
      .attr('fill', '#ffffff')
